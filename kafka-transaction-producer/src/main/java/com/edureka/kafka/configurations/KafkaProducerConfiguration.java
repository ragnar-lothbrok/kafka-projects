...
public class KafkaProducerConfiguration {
	...
	@Bean
	public Producer<String, Transaction> productEventProducer() {
		...
		Producer<String, Transaction> producer = new KafkaProducer<String, Transaction>(props, stringKeySerializer(),
				new CustomJsonSerializer<Transaction>());
