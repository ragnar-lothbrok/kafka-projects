...
public class ProductRepository {
	...
	public void insertProduct(Product product) {
		StringBuilder sb = new StringBuilder("INSERT INTO ").append(TABLE_NAME)
				.append("(pogid, brand, description, category,subcategory,price) ").append("VALUES (")
				...
				.append(product.getSubCategory()).append("',").append(product.getPrice()).append(");");
	...
	public Product selectByPogId(long pogId) {
		...
		for (Row r : rs) {
			Product s = new Product(r.getLong("pogid"), r.getString("brand"), r.getString("description"),
					r.getString("category"), r.getString("subcategory"), r.getFloat("price"));
			products.add(s);
		}
